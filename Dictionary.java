...
public interface Dictionary {
    ...
    /**
     * Adds the given word to the dictionary's binary tree.  Trim words before adding them to the
     * tree.  Do not add any duplicates to the tree.  Use .compareToIgnoreCase() for comparisons.
     *
     * @param word
     */
